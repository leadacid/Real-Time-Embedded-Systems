...
//***** CONFIG *****************************************************************
//
static const char* kSyslogPrefixStr = "[COURSE:2][ASSIGNMENT:4]";
...
static const struct {
    ...
    {service3, 7, -3, kServicesCPU, 1},
    {service4, 13, -4, kServicesCPU, 2},
};
// LCM of all periods should be calced: and used as a wraparound time point
static const int kLCMPeriod = 910; // sequence will repeat each kLCMPeriod ticks
//
//******************************************************************************
