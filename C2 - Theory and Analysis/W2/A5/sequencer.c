...
//***** CONFIG *****************************************************************
//
static const char* kSyslogPrefixStr = "[COURSE:2][ASSIGNMENT:5]";
...
static const struct {
    ...
    {service2,  5, -2, kServicesCPU, 2}, 
    {service3, 10, -3, kServicesCPU, 1},
};
// LCM of all periods should be calced: and used as a wraparound time point
static const int kLCMPeriod = 10; // sequence will repeat each kLCMPeriod ticks
//
//******************************************************************************
